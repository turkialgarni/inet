...
class INET_API IPv4Address
{
  ...
  public:
    ...
    /**
     * Returns the network part of the address, assuming a netmask of the given length.
     */
    IPv4Address getNetworkPart(int netmaskLength) const {_checkNetmaskLength(netmaskLength); return addr & _makeNetmask(netmaskLength);}

    /**
     * Returns the host part of the address, assuming a netmask of the given length.
     */
    IPv4Address getHostPart(int netmaskLength) const {_checkNetmaskLength(netmaskLength); return addr & ~_makeNetmask(netmaskLength);}
